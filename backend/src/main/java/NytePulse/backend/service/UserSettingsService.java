...
public class UserSettingsService {
    ...
    public UserSettingsDTO createDefaultSettings(Long userId) {
        ...
        UserSettings settings = UserSettings.builder()
                .user(user)
                .postVisibility(PostVisibility.EVERYONE)
                .storyVisibility(StoryVisibility.EVERYONE)
                .commentVisibility(CommentVisibility.EVERYONE)
                .mentionVisibility(MentionVisibility.EVERYONE)
                .tagVisibility(TagVisibility.EVERYONE)
                .storyCommentVisibility(StoryCommentVisibility.EVERYONE)
